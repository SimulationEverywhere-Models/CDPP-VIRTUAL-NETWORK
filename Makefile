...
LDFLAGS += -L.
#^|
EXAMPLESOBJS=  managing_console.o register.o server1.o server2.o server3.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#D
...
#^|
managing_console.o: /cygdrive/C/eclipse/workspace/test2/managing_console.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/test2/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
server1.o: /cygdrive/C/eclipse/workspace/test2/server1.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
server2.o: /cygdrive/C/eclipse/workspace/test2/server2.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
server3.o: /cygdrive/C/eclipse/workspace/test2/server3.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
managing_console.o: \
 /cygdrive/C/eclipse/workspace/test2/managing_console.cpp \
 /cygdrive/C/eclipse/workspace/test2/managing_console.h \
...
register.o: /cygdrive/C/eclipse/workspace/test2/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/portlist.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/queue.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/generat.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/cpu.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/transduc.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/message.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/strutil.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/trafico.h \
 /cygdrive/C/eclipse/workspace/test2/managing_console.h \
 /cygdrive/C/eclipse/workspace/test2/server2.h \
 /cygdrive/C/eclipse/workspace/test2/server3.h \
 /cygdrive/C/eclipse/workspace/test2/server1.h
server1.o: /cygdrive/C/eclipse/workspace/test2/server1.cpp \
 /cygdrive/C/eclipse/workspace/test2/server1.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201109022248/internal/model.h \
